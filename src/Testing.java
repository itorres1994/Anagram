...
public class Testing {
	...
	public static void main(String[] args) {
		...
		String currentDirectory = new File("").getAbsolutePath() + "\\src\\dict1";
		
		//Object used to find dict2
		String currentDirectory2= new File("").getAbsolutePath() + "\\src\\dict2";
		...
		try {
			...
			myMap.numberOfAnagramClasses("anagram1");
			...
			myMap.numberOfAnagramClasses("anagram2");
